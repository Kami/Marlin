...
#define STRING_CONFIG_H_AUTHOR "FiZi based on Aaron Just, CR10-V2" // Who made the changes.
...
#define Z_MAX_POS 300 // 410 - note 400 won't work due to the frame support braces being hit by the direct drive extruder when the extruder is at Y zero. In reality, we could go to 320, but 300 is a safer value
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
